                        ...
                        if (row.status === 'Processing') {
                            btn = h(
                                ...
                                { 'class': 'order_dispatch_btn', attrs: { type: 'success', size: 'mini' },
                                    on: {
                                        'click': function click() {
                                            return _this.dispatchOrder(row, 'Completed');
                                        }
                                    }
                                },
                                ['Dispatch']
                            ...
                            btn = h(
                                ...
                                { 'class': 'order_dispatch_btn', attrs: { type: 'danger', size: 'mini' },
                                    on: {
                                        'click': function click() {
                                            return _this.dispatchOrder(row, 'Processing');
                                        }
                                    }
                                },
                                ['Reverse Dispatch']
                    ...
                    formatter: function (row, column, cellValue) {
                        ...
                        lines.push(h(
                            'li',
                            {
                                on: {
                                    'click': function click() {
                                        return _this2.copy(row.customer.email);
                                    }
                                },
                        ...
                        lines.push(h(
                            'li',
                            {
                                on: {
                                    'click': function click() {
                                        return _this2.copy(row.customer.phone);
                                    }
                                },
                                style: 'cursor: copy;' },
                        ...
                        return h(
                            ...
                            [h(
                                ...
                                'el-button',
                                {
                                    ...
                                    on: {
                                        'click': function click() {
                                            return _this2.copy(address.join(', '));
                                        }
                                    }
                                },
                                ['Copy Address']
