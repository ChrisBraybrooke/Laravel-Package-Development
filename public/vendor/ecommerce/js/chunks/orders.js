    ...
    computed: {
        total: function total() {
            ...
            forEach(this.additions, function (addition) {
                if (addition.Amount) {
                    addition_total = addition_total + _this.simplePrice(addition.Amount);
                }
            });
    ...
    methods: {
        ...
        addObject: function addObject() {
            ...
            this.$refs['form'].validate(function (valid, errors) {
                if (valid) {
                    var obj_length = Object.keys(_this3.additions).length;
                    obj_length = obj_length + 1;
                    _this3.$set(_this3.additions, 'Multi ' + _this3.individualName + ' ' + obj_length, _this3.model);
...
exports.default = {
    ...
    methods: {
        ...
        label: function label(key) {
            return this.capitalize(_content2.default.inputLabel(key));
        },
...
exports.default = {
    ...
    components: {
        ...
        PaymentForm: function PaymentForm() {
            return __webpack_require__.e/* import() */(41).then(__webpack_require__.bind(null, "./resources/assets/admin-spa/components/PaymentForm.vue"));
        }
    },
...
var _AdditionForm = __webpack_require__("./resources/assets/admin-spa/components/AdditionForm.vue");

var _AdditionForm2 = _interopRequireDefault(_AdditionForm);
...
exports.default = {
    ...
    components: {
        AdditionForm: _AdditionForm2.default
    },
    ...
    mounted: function mounted() {
        ...
        if (this.col.value) {
            this.temp = _collumn2.default.dotToObjectPath(_collumn2.default.replaceWhereLookup(this.col.value, this.row), this.row);
        }
    },
    ...
    computed: {
        ...
        button: function button() {
            ...
            var real_value = _collumn2.default.dotToObjectPath(_collumn2.default.replaceWhereLookup(this.col.value, this.row), this.row);
            ...
            if (!hide_button_if_value && !extra_content || !hide_button_if_value || hide_button_if_value && !extra_content || hide_button_if_value && button.only_show_hover && !real_value) {
                button_content = h(
                    "el-button",
                    {
                        ...
                        "class": button.only_show_hover ? 'order_dispatch_btn' : '', on: {
            ...
            return h(
                ...
                [h(
                    "span",
                    { "class": button.only_show_hover && button_content !== '' ? 'order_dispatch_text' : '' },
                    [extra]
                ), button_content]
            );
        },
        ...
        text: function text() {
            ...
            var value = this.value;
            return h("el-input", (0, _babelHelperVueJsxMergeProps2.default)([{
                attrs: {
                    value: _this3.temp
                },
                on: {
        ...
        number: function number() {
            ...
            var value = this.value;
            return h("el-input-number", (0, _babelHelperVueJsxMergeProps2.default)([{
                attrs: {
                    value: _this4.temp
                },
                on: {
        ...
        addition: function addition() {
            ...
            if ((typeof value === "undefined" ? "undefined" : _typeof(value)) !== 'object' || this.value.length == 0) {
                value = {};
            }
            ...
            return h(
                "addition-form",
                {
                    attrs: { "form-name": addition.form_name,
                ...
                [function (props) {
                    return h(
                        ...
                        [addition.add_button_text ? addition.add_button_text : 'Add']
                    );
                }]
            );
        },
        value: function value() {
            return _collumn2.default.dotToObjectPath(_collumn2.default.replaceWhereLookup(this.col.value, this.row), this.row);
        }
    },
...
exports.default = {
    ...
    computed: _extends({}, (0, _vuex.mapGetters)(['order', 'shopData']), {
    ...
    methods: _extends({}, (0, _vuex.mapActions)(['resetOrder']), {
         ...
         * @return Void
         */
        handleCustomerSelect: function handleCustomerSelect(item) {
            console.log(item);
...
var productFormTemplate = _defineProperty({
    edit: false,
    product: {
        quantity: 1
...
exports.default = {
    ...
    components: {
        ...
        ProductForm: function ProductForm() {
            return __webpack_require__.e/* import() */(37).then(__webpack_require__.bind(null, "./resources/assets/admin-spa/components/ProductForm.vue"));
        },
        ProductTable: function ProductTable() {
            return __webpack_require__.e/* import() */(36).then(__webpack_require__.bind(null, "./resources/assets/admin-spa/components/ProductTable.vue"));
        }
    },
        ...
        formatTotalRow: function formatTotalRow(row, column, cellValue) {
            ...
            if (row.total === 'Shipping') {
                ...
                forEach(this.shippingRange, function (range) {
                    options.push(h('el-option', { key: range, attrs: { value: range }
                    }));
                });

                return h('div', [this.shopData.currency, ' ', h(
                    'el-select',
...
var _OrderNotes = __webpack_require__("./resources/assets/admin-spa/components/OrderNotes.vue");

var _OrderNotes2 = _interopRequireDefault(_OrderNotes);
...
exports.default = {
                ...
                collumns: [{
                    ...
                    formatter: function (row, column, cellValue) {
                        ...
                        return h('order-notes', {
                            attrs: { notes: hasIndex ? row.content.data[notesIndex].content : {} },
                            on: {
                    ...
                    formatter: function (row, column, cellValue) {
                        ...
                        if (row.status === 'Processing') {
                            btn = h(
                                'el-button',
                                { 'class': 'order_dispatch_btn', attrs: { type: 'success', size: 'mini' },
                                    on: {
                                        'click': function click() {
                            ...
                            btn = h(
                                'el-button',
                                { 'class': 'order_dispatch_btn', attrs: { type: 'danger', size: 'mini' },
                                    on: {
                                        'click': function click() {
                        ...
                        return h(
                            ...
                            [h(
                                ...
                                'el-button',
                                {
                                    ...
                                    on: {
                                        'click': function click() {
                                            return _this3.copy(address.join(', '));
                                        }
                                    }
                                },
                                ['Copy Address']
                    ...
                    formatter: function formatter(row) {
                        ...
                        return h(
                            ...
                            [payment_info, h(
                                'payments',
                                {
                                    attrs: { payments: row.payments.data,
                                        order: row,
                                        'show-payments': false,
                                ...
                                'div',
                                { slot: 'reference' },
                                [h('strong', [_this4.formatPrice(_order2.default.paymentTotal(row.payments.data), row.cart.currency)])]
                            )]
                        );
                    },
                    align: 'left',
    ...
    mounted: function mounted() {
        ...
        if (this.objectHas(ecommerceConfig, 'aditional_cols.orders')) {
            forEach(ecommerceConfig.aditional_cols.orders, function (col) {
                var col_index = findIndex(_this5.tableOptions.collumns, ['prop', col.prop]);
                ...
                if (col_index === -1) {
                    ...
                    _this5.tableOptions.collumns[col_index] = col;
                }
            });
        }
        this.tableOptions.collumns.push({
            ...
            formatter: function (row, column, cellValue) {
                ...
                var type = row.status == _order2.default.getStatusNameFromCode('STATUS_COMPLETED') ? 'success' : row.status == _order2.default.getStatusNameFromCode('STATUS_PROCESSING') ? 'danger' : 'info';
    ...
    methods: {
        ...
        paymentAdded: function paymentAdded(row, payment) {
            ...
            var payments = this.simplePrice(_order2.default.paymentTotal(row.payments.data)) + this.simplePrice(payment.amount);
            var status_is_awaiting_payment = row.status === _order2.default.getStatusNameFromCode('STATUS_AWAITING_PAYMENT');
            ...
            if (status_is_awaiting_payment && payments_are_more_than_total) {
                row.status = _order2.default.getStatusNameFromCode('STATUS_PROCESSING');
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8c90e0c8\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/AdditionForm.vue":
/***/ (function(module, exports, __webpack_require__) {
                    ...
                    [
                      ...
                      _vm._l(_vm.order.shipping_address, function(line, key) {
                        return !_vm.edit_shipping
                          ? _c("div", { key: key, staticClass: "text item" }, [
                              _c("strong", [
                                _vm._v(
              ...
              _c("product-form", {
                attrs: {
                  "on-product-add": function(product) {
                    this$1.order.items.push(product)
                  }
                }
              })
            ],
                  ...
                  _c(
                    ...
                    [
                      _c("el-autocomplete", {
                        attrs: {
                          autofocus: true,
                          disabled: _vm.order.customer.id ? true : false,
                          "value-key": "company",
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-8c90e0c8\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/admin-spa/components/AdditionForm.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "el-button",
        { attrs: { size: "mini" }, on: { click: _vm.openModal } },
        [_vm._v("Notes")]
      ),
      _vm._v(" "),
      _vm.showModal
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8c90e0c8\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/AdditionForm.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8c90e0c8\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/AdditionForm.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("dcfaab78", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8c90e0c8\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdditionForm.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8c90e0c8\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AdditionForm.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__("./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8c90e0c8\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/AdditionForm.vue")
}
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/admin-spa/components/AdditionForm.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-8c90e0c8\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/admin-spa/components/AdditionForm.vue")
/* template functional */
