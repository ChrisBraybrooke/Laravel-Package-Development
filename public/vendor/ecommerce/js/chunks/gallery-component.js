...
exports.default = {
    ...
    components: {
        FileUploadComponent: function FileUploadComponent() {
            return __webpack_require__.e/* import() */(39).then(__webpack_require__.bind(null, "./resources/assets/admin-spa/components/FileUploadComponent.vue"));
        },
    ...
    methods: {
        ...
        formatPercentage: function formatPercentage(num) {
            return parseInt(num);
        },
        ...
        getFiles: function getFiles() {
            ...
            var limit = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 24;
            var ascending = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
            var syncMeta = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : true;
            var load = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : true;
            var silentErrors = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : false;
        ...
        handleLoadMoreFiles: function handleLoadMoreFiles() {
            this.getFiles(true, false, this.galleryMeta.current_page + 1);
        },
        shouldShowProgress: function shouldShowProgress(file) {
        ...
        handleMultipleFileClick: function handleMultipleFileClick(file, e) {
            var _this = this;
            ...
            if (e.metaKey || e.ctrlKey) {
                ...
                multiple_selects.forEach(function (file) {
        ...
        sliceSeletedFiles: function sliceSeletedFiles(files) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b2f407\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/GalleryComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.gallery_file_wrap[data-v-78b2f407] {\n  /* min-width: 200px; */\n}\n.media_search[data-v-78b2f407] {\n    margin-top: 20px;\n    margin-bottom: 10px;\n}\n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-78b2f407\",\"hasScoped\":true,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/admin-spa/components/GalleryComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      class: _vm.inModal
        ? "gallery_component gallery_dialog_component"
        : "gallery_component"
    },
    [
      ...
      _c("file-upload-component", {
        attrs: { "gallery-id": _vm.galleryId, "file-list": _vm.files },
        on: {
          fileUploadSuccess: _vm.handleUploadSuccess,
          fileSelected: _vm.handlefileSelected,
          fileUploadError: _vm.handleFileUploadError
        }
      }),
      _vm._v(" "),
      _c(
        ...
        [
          _c(
            ...
            [
              _c("el-input", {
                staticClass: "media_search",
                attrs: { placeholder: "Search", autofocus: true },
                model: {
                  value: _vm.galleryMeta.search,
                  callback: function($$v) {
                    _vm.$set(_vm.galleryMeta, "search", $$v)
                  },
                  expression: "galleryMeta.search"
                }
              })
            ],
            1
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("el-col", [
                _c("small", [
                  _vm._v("Showing: "),
                  _c("strong", [_vm._v(_vm._s(_vm.files.length))]),
                  _vm._v(" of "),
                  _c("strong", [_vm._v(_vm._s(_vm.galleryMeta.total))])
                ])
              ])
            ],
            1
          ...
          _vm._v(" "),
          _vm._l(_vm.galleryImageChunks, function(chunk) {
            return [
              _c(
                "el-row",
                { staticClass: "gallery_row", attrs: { gutter: 0 } },
                [
                  _vm._l(chunk, function(file, index) {
                    return [
                      _c(
                        ...
                        [
                          _vm.shouldShowProgress(file)
                            ? _c(
                                "div",
                                { staticClass: "gallery_file_wrap_progress" },
                                [
                                  _c("el-progress", {
                                    staticClass: "progress_object",
                                    attrs: {
                                      type: "circle",
                                      percentage: _vm.formatPercentage(
                                        file.percentage
                                      ),
                                      status:
                                        file.status === "fail"
                            ...
                            : _vm._e(),
                          _vm._v(" "),
                          _vm.shouldShowProgress(file) && file.status === "fail"
                            ? _c(
                                "div",
                                { staticClass: "gallery_file_wrap_cancel" },
                                [
                                  _c(
                                    "p",
                                    {
                                      staticClass: "gallery_file_wrap_icon",
                                      attrs: { id: "cancel" },
                                      on: {
                                        click: function($event) {
                            ...
                            ? _c(
                                ...
                                [
                                  !_vm.fileInSelects(file)
                                    ? _c("i", {
                                        staticClass:
                                          "el-icon-view gallery_file_wrap_icon",
                                        attrs: { id: "view" },
                                        on: {
                                          click: function($event) {
                                  ...
                                  _vm.fileInSelects(file)
                                    ? _c("i", {
                                        staticClass:
                                          "el-icon-check gallery_file_wrap_icon"
                                      })
                                    : _vm._e(),
                                  _vm._v(" "),
                                  !_vm.fileInSelects(file)
              ...
              _c(
                ...
                [
                  _c(
                    "el-button",
                    {
                      staticClass: "load_more_btn",
                      attrs: {
                        disabled: _vm.meta.total <= _vm.files.length,
                        type: "success",
                        plain: ""
                      },
                      on: { click: _vm.handleLoadMoreFiles }
                    },
                    [_vm._v("Load More")]
                  )
                ],
          ...
          _c(
            ...
            {
              attrs: {
                title: _vm.fileDialog.file.name,
                visible: _vm.fileDialog.show,
                fullscreen: true,
                "append-to-body": true,
                center: ""
              },
              ...
              _c(
                ...
                [
                  _c("el-col", { attrs: { span: 18 } }, [
                    _c("h4", { staticClass: "conversion_title" }, [
                      _vm._v("Full Resolution")
                    ]),
                    _vm._v(" "),
                    _c("img", {
                      staticStyle: { width: "100%" },
                      attrs: {
                        src: _vm.fileDialog.file.url,
                        title: _vm.fileDialog.file.name
                      }
                    })
                  ]),
                  ...
                  _c(
                    ...
                    { attrs: { span: 6 } },
                    [
                      _vm._l(_vm.fileDialog.file.conversions, function(
                        conversion,
                        key
                      ) {
                        return [
                          _c("h4", { staticClass: "conversion_title" }, [
                            _vm._v(_vm._s(_vm.ucFirst(key)))
                          ]),
                          _vm._v(" "),
                          _c("img", {
                            staticStyle: { width: "100%" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-78b2f407", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b2f407\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/GalleryComponent.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b2f407\",\"scoped\":true,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/GalleryComponent.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("d76cbf26", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b2f407\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./GalleryComponent.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b2f407\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./GalleryComponent.vue");
...
/***/ "./resources/assets/admin-spa/components/GalleryComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/* scopeId */
var __vue_scopeId__ = "data-v-78b2f407"
...
Component.options.__file = "resources/assets/admin-spa/components/GalleryComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-78b2f407", Component.options)
  } else {
    hotAPI.reload("data-v-78b2f407", Component.options)
  }
