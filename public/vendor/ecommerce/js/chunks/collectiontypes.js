  ...
  computed: {
    ...
    collectionTypeFormRules: function collectionTypeFormRules() {
      return {
        name: [{
          required: true,
          message: 'The ' + this.typeName + ' name field is required',
          trigger: 'blur'
        }],
        individual_name: [{
          required: true,
          message: 'The ' + this.typeName + ' individual name field is required',
          trigger: 'blur'
        }],
        slug: [{
          required: true,
          message: 'The ' + this.typeName + ' slug field is required',
          trigger: 'blur'
        }]
      };
    }
                        ...
                        [
                          _vm.collectionType.content
                            ? _c("content-component", {
                                attrs: {
                                  content: _vm.collectionType.content.data
                                }
                              })
                            : _vm._e()
                        ],
                        ...
                        [
                            ...
                            [
                              ...
                              _c(
                                "el-button",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.addSpecificationValue(
                                        _vm.spec,
                                        "specifications"
                                      )
                                    }
                          ...
                          _c(
                            "el-button",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.addSpecification("specifications")
                                }
                              }
                            },
                        ...
                        [
                          ...
                          _c(
                            "el-button",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.addSpecification("options", {
                                    value: {
                                      name: "",
                                      file: null,
