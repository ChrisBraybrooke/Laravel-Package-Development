...
exports.default = {
    ...
    components: {
        GalleryComponent: function GalleryComponent() {
            return __webpack_require__.e/* import() */(40).then(__webpack_require__.bind(null, "./resources/assets/admin-spa/components/GalleryComponent.vue"));
        },
    ...
    methods: {
        setCurrentGallery: function setCurrentGallery() {
            ...
            var gallery = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        ...
        getFiles: function getFiles() {
            var gallery = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        ...
        getGalleryFromTabIndex: function getGalleryFromTabIndex(tabIndex) {
            if (tabIndex) {
        ...
        getGalleriesArrayIndex: function getGalleriesArrayIndex(galleryId) {
            if (galleryId) {
                var galleryIndex = findIndex(this.galleries, function (g) {
        ...
        handleFileSelected: function handleFileSelected(data) {
            this.files[data.gallery].unshift(data.file);
        },
        handleFileDeleted: function handleFileDeleted(data) {
        ...
        handleFileUploadSuccess: function handleFileUploadSuccess(data) {
        ...
        handleFileUnHighlighted: function handleFileUnHighlighted(data) {
            this.selectedFiles = data.selectedFiles;
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-290517a9\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/GalleriesComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-290517a9\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/admin-spa/components/GalleriesComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
    ...
    [
      _c(
        ...
        [
          _c(
            "el-popover",
            {
              ref: "addGalleryPopover",
              attrs: { placement: "right", width: "300", trigger: "click" },
              model: {
                value: _vm.addGalleryPopoverVisible,
                callback: function($$v) {
                  _vm.addGalleryPopoverVisible = $$v
                },
                expression: "addGalleryPopoverVisible"
              }
            },
            [
              _c(
                "el-form",
                {
                  ...
                  attrs: {
                    inline: true,
                    rules: _vm.createGalleryRules,
                    model: _vm.createGalleryForm
                  },
                  nativeOn: {
                    ...
                    keyup: function($event) {
                      ...
                      return _vm.createGallery($event)
                    }
                  }
                },
                [
                  _c(
                    "el-form-item",
                    { ref: "createGalleryName", attrs: { prop: "name" } },
                    [
                      _c("el-input", {
                        attrs: { placeholder: "Gallery Name" },
                        model: {
                          value: _vm.createGalleryForm.name,
                          callback: function($$v) {
                            _vm.$set(_vm.createGalleryForm, "name", $$v)
                          },
                          expression: "createGalleryForm.name"
                        }
                      })
                    ],
                    1
            ...
            ? _c(
                "el-button",
                {
                  directives: [
                    {
                      name: "popover",
                      rawName: "v-popover:addGalleryPopover",
                      arg: "addGalleryPopover"
                    }
                  ],
                  attrs: { size: "small", type: "primary", plain: "" },
                  on: {
                    click: function($event) {
                      _vm.addGalleryPopoverVisible = true
                    }
                  }
                },
      ...
      _c(
        "el-popover",
        {
          ...
          model: {
            value: _vm.deleteGalleryPopoverVisible,
            callback: function($$v) {
              _vm.deleteGalleryPopoverVisible = $$v
            },
            expression: "deleteGalleryPopoverVisible"
          }
        },
        [
            ...
            [
              _c(
                "el-button",
                {
                  ...
                  on: {
                    click: function($event) {
                      _vm.deleteGalleryPopoverVisible = false
                    }
                  }
                },
                [_vm._v("cancel")]
      ...
      _c(
        ...
        _vm._l(_vm.galleries, function(gallery, index) {
          return _c(
            ...
            {
              key: gallery.id,
              attrs: { label: gallery.name, name: gallery.id.toString() }
            },
            [
              _vm.showGallery[gallery.id] && _vm.showGallery[gallery.id].show
                ? _c("gallery-component", {
                    attrs: {
                      "gallery-id": gallery.id,
                      "get-gallery-files": false,
                      "in-modal": _vm.inModal,
                      meta: gallery.meta,
                      selectable: _vm.gallerySelectable[gallery.id]
                        ? _vm.gallerySelectable[gallery.id]
                        : undefined,
                      "gallery-files": _vm.files[gallery.id]
                        ? _vm.files[gallery.id]
                        : []
                    },
                    on: {
                      fileSelected: _vm.handleFileSelected,
                      fileDeleted: _vm.handleFileDeleted,
                      fileUnHighlighted: _vm.handleFileUnHighlighted,
                      fileHighlighted: _vm.handleFileHighlighted,
                      fileUploadSuccess: _vm.handleFileUploadSuccess,
                      fileUploadError: _vm.handleFileUploadError,
                      mediaSearch: _vm.handleMediaSearch
                    }
                  })
                : _vm._e()
            ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-290517a9", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-290517a9\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/GalleriesComponent.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-290517a9\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/admin-spa/components/GalleriesComponent.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("67ab7948", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-290517a9\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./GalleriesComponent.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-290517a9\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./GalleriesComponent.vue");
...
/***/ "./resources/assets/admin-spa/components/GalleriesComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
Component.options.__file = "resources/assets/admin-spa/components/GalleriesComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-290517a9", Component.options)
  } else {
    hotAPI.reload("data-v-290517a9", Component.options)
  }
